...
RumiRoutine is a chore tracker with game-like features, designed to help young adults manage shared chores in a fun and motivating way. You can create and assign chores with details like the title, description, due date, XP status, and who’s responsible. You can choose from common chores or add your own to fit your household. 
